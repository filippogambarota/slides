...
# A simple framework for collaboration <br/> in a literate programming workflow
...
# Most relevant featues

* Support for both `.Rmd` and `Rnw` files

</br>

* Powerful system to **hide/restore and backup code chunks** during between the `upload` and `download` process

</br>

* Perfectly integrated with a GIT workflow
